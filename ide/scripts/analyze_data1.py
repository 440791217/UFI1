...
def parse_files(val_fs):
    ...
    for fp in val_fs:
        ...
        with open(fp,'r') as rf:
            ...
            for ln in lines:
                ...
                if 'FAULT_DETECTED_DWC' in ln:
                    ...
                    # print('FAULT_DETECTED_DWC：', fp)
                if 'FAULT_DETECTED_RWC' in ln:
                    FAULT_DETECTED_RWC+=1
                    print('FAULT_DETECTED_RWC：', fp)
                if 'HardFault_Handler' in ln:
                    HardFault_Handler+=1
                    print('HardFault_Handler：',fp)
        ...
        elif start_main>0 or start_intermain<3:
            result_map['due']+=1
...
if __name__=='__main__':
    ...
    # analyze_data(input_path='/home/mark/github/UFI1/ide/out/RF')
